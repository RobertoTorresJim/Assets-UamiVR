...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		//[SerializeField] float m_JumpPower = 0f;//El salto no será utilizado en este proyecto
        ...
        */
		...
		void UpdateAnimator(Vector3 move)
		{
			...
			//m_Animator.SetBool("Crouch", m_Crouching); METODO PARA AGACGARSE ANIMACION
			m_Animator.SetBool("OnGround", m_IsGrounded);
            
			/* METODO PARA SALTAR
             * if (!m_IsGrounded)
			{
				m_Animator.SetFloat("Jump", m_Rigidbody.velocity.y); ANIMACION
			}
            */
		...
		void HandleAirborneMovement(bool sit)
		{
			...
			//m_GroundCheckDistance = m_Rigidbody.velocity.y < 0 ? m_OrigGroundCheckDistance : 0.8f;
